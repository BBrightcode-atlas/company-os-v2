...
- 기능 요구사항(Functional Requirements)은 기능 정의서 목록(Feature Definition Index)과 기능별 기능 정의서(Feature Definition)로 분리한다.
    - **기획서 > PRD > 기능 정의서 목록 > 기능정의서**
    - 화면정의서 목록 > 공통레이아웃 정의서, 화면정의서
...
| --- | --- | --- | --- | --- |
| `deliverable.standard_plan` | 표준 기획서(Standard Plan) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/standard-plan.md` | Blueprint |
| `deliverable.prd` | PRD(Product Requirements Document) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/prd.md` | Blueprint |
| `deliverable.feature_index` | 기능 정의서 목록(Feature Definition Index) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/feature-definition-index.md` | Blueprint |
| `deliverable.feature_files` | 기능별 기능 정의서(Feature Definitions) | Project document slot collection | `bbr-plugins/cos-blueprint/templates/deliverables/feature-definition.md` | Blueprint |
| `deliverable.schema_definition` | 스키마 정의서(Schema Definition) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/schema-definition.md` | Blueprint |
| `deliverable.api_definition` | API 정의서(API Definition) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/api-definition.md` | Blueprint |
| `deliverable.interface_definition` | 인터페이스 정의서(Interface Definition) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/interface-definition.md` | Blueprint |
| `deliverable.layout_definition` | 공통 레이아웃 정의서(Common Layout Definition) | Project document slot | `bbr-plugins/cos-blueprint/templates/deliverables/layout-definition.md` | Blueprint |
| `deliverable.screen_definitions` | 화면정의서(Screen Definitions) | Project document slot collection | `bbr-plugins/cos-blueprint/templates/deliverables/screen-definition.md` | Blueprint |
| `deliverable.wireframe_html` | HTML 와이어프레임(HTML Wireframe) | Project artifact/document slot | `bbr-plugins/wireframe-builder/templates/wireframe-html-prompt.md` | Wireframe |
| `deliverable.build_plan` | BuildPlan | Project document slot | `bbr-plugins/product-builder/templates/build-plan.md` | Project Builder |
| `deliverable.task_list` | 전체 Task 목록(Full Task List) | Project document slot | `bbr-plugins/product-builder/templates/task-list.md` | Project Builder |
...
| 6 | 표준 산출물 문서 기록(Standard Document Write) | `write-standard-plan-docs` | 표준 기획서, PRD, 기능/계약 문서 | deliverable slot 갱신 | PM 검토 |
...
| --- | --- | --- |
| 표준 기획서(Standard Plan) | `deliverable.standard_plan` | 프로젝트 목표, 범위, 요구사항, 전제, 리스크의 기준선 |
| PRD(Product Requirements Document) | `deliverable.prd` | 사용자 문제, 대상 사용자, 성공 기준, 제품 요구사항 |
| 기능 정의서 목록(Feature Definition Index) | `deliverable.feature_index` | 기능명과 기능별 Project slot 문서 참조 목록 |
...
| 인터페이스 정의서(Interface Definition) | `deliverable.interface_definition` | 화면, 스키마, API 사이의 연결과 추적성 |
| 공통 레이아웃 정의서(Common Layout Definition) | `deliverable.layout_definition` | 반복되는 레이아웃과 slot 기준 |
...
| `deliverable.feature_index` | 기능 정의서 목록(Feature Definition Index) |
...
| 기능 정의서 목록(Feature Definition Index) | `write-standard-plan-docs` | 기능명 + 기능별 Project slot 문서 참조 | BuildPlan feature 목록 |
