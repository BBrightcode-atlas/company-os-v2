...
export function buildBlueprintPmAgentPrdPrompt(input: {
  ...
  return [
    ...
    "",
    "목표: 등록된 Source Material을 끝까지 읽고, PRD(Product Requirements Document)와 Product Builder 기준선/계약 초안을 작성한 뒤 반드시 Paperclip MCP 도구 `paperclipExecutePluginTool`로 `paperclip-plugin-builder:submit-blueprint-prd`를 실행해 제출한다.",
    "",
    "## 실행 규칙",
    "",
    ...
    "7. 최종 답변만 남기지 말고 반드시 `paperclipExecutePluginTool` 도구를 호출한다. tool 값은 `paperclip-plugin-builder:submit-blueprint-prd`다.",
    "",
    "## 제출 도구",
    "",
    "`paperclipExecutePluginTool` 호출:",
    "- tool: `paperclip-plugin-builder:submit-blueprint-prd`",
    "- projectId: 아래 Project ID",
    "- parameters 또는 parametersJson: 아래 `submit-blueprint-prd` payload",
    "",
