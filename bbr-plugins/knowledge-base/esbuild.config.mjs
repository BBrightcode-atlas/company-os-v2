...
// pnpm misroutes the SDK's `@paperclipai/shared` import to the stale public-npm
// 0.3.1 (missing PLUGIN_API_VERSION 등). Force every bundle to resolve shared to
// the local v2 tarball that ships with the vendored SDK.
