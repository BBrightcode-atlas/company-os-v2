...
const manifest: PaperclipPluginManifestV1 = {
  ...
  tools: [
    {
      ...
      description: "LLM Wiki 페이지를 제목/태그/본문으로 검색한다. 답을 알거나 글을 쓰기 전 먼저 위키를 확인하라.",
      parametersSchema: {
        type: "object",
    ...
    },
    {
      ...
      description: "raw 소스(원문)를 LLM Wiki 에 추가한다. 이후 사람이 ingest 하면 위키로 통합된다.",
      parametersSchema: {
        type: "object",
  ...
  skills: [
    {
      skillKey: "maintainer",
      displayName: "LLM Wiki 유지 규칙",
      description: "이 회사 LLM Wiki 관리 규칙과 wiki:* 도구 사용법.",
