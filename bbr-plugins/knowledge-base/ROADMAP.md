...
## 진행 상태 (2026-06-06)
- ✅ Phase 1 복리코어 (index/log/2-pass ask/답변환원) — push 4c53b908
- ✅ Phase 2 깊은 ingest (provenance 소스페이지 + HITL 검토/적용/거부, 원자 claim) — 2097ecc5
- ✅ Phase 3 maintain/lint (구조 점검 + AI 중복/모순/누락 탐지) — 76cd5c94. aliases 미구현(후순위).
- ✅ Phase 5 Postgres FTS (생성 tsvector+GIN, OR 하이브리드 검색) — 8df6918f
- ✅ Phase 4 그래프 kind필터/고아 dim + ask 표 nudge — 48d43690
- 남은 후보: aliases, 비교표 전용 답변 액션, frontmatter 표 뷰, revision 히스토리, 배치 ingest, URL 임포트.
