...
export const DEFAULT_RATE_SHEET: RateSheetSeed[] = [
  ...
  { category: "인증/계정", item: "권한·역할 관리(기본: 멤버/관리자)", scopeBasis: "멤버/관리자 등 단순 역할 구분", standardPrice: 1_500_000, note: "세분 권한은 RBAC 항목" },
  { category: "인증/계정", item: "권한·역할 관리(RBAC 세분화)", scopeBasis: "리소스별 세분 권한/역할 매핑·정책", standardPrice: 3_000_000, note: "역할 수/정책 복잡도 따라 가감" },
  ...
  { category: "미디어/게시", item: "게시판·댓글·대댓글", scopeBasis: "단순 게시판 CRUD/좋아요/대댓글", standardPrice: 1_500_000, note: "모더레이션은 커뮤니티 항목 참조" },
  { category: "커뮤니티", item: "커뮤니티 피드·팔로우·멘션", scopeBasis: "피드/팔로우/멘션/해시태그/공유", standardPrice: 2_500_000, note: "소셜 커뮤니티 기본" },
