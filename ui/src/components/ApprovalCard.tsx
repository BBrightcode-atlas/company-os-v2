            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-5 text-muted-foreground">
                  {t("approvalCard.requestCreated")} {timeAgo(approval.createdAt)}
                </p>
              </div>
            </div>
          </div>
            ...
            {showResolutionButtons && (
              <>
                <Button
                  ...
                  disabled={isPending}
                >
                  {pendingAction === "approve" ? t("approvalCard.approving") : t("action.approve")}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
                  ...
                  disabled={isPending}
                >
                  {pendingAction === "reject" ? t("approvalCard.rejecting") : t("action.reject")}
                </Button>
              </>
            )}
          </div>
