...
type ProjectBaseTab = "overview" | "list" | "plugin-operations" | "workspaces" | "configuration" | "budget" | "environments";
...
function EnvironmentsTabContent({ companyId, projectId }: { companyId: string; projectId: string }) {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      pushToast({ title: "Environment deleted", tone: "success" });
    },
    onError: (err: any) => {
      pushToast({ title: err?.message ?? "Failed to delete environment", tone: "error" });
    },
  });
