...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("sidebar.company") }]);
  }, [setBreadcrumbs]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("company.loadingCompanies")}</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("company.agents").replace("{count}", String(agentCount))}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t("company.issues").replace("{count}", String(issueCount))}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("company.created").replace("{time}", relativeTime(company.createdAt))}</span>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 ml-4 shrink-0">
                    ...
                    <Button
                      ...
                      disabled={deleteMutation.isPending}
                    >
                      {deleteMutation.isPending ? t("company.deleting") : t("action.delete")}
                    </Button>
                  </div>
                </div>
              )}
